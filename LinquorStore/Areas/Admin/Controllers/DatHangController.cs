...
namespace LinquorStore.Controllers
{
    ...
    public class DatHangController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TaiKhoanId,KhachHangId,DienThoaiGiaoHang,DiaChiGiaoHang,NgayDatHang,TinhTrang,NgayXacNhan")] DatHang datHang)
        {
            if (id != datHang.Id)
            {
                return NotFound();
