...
namespace LinquorStore.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var o = _context.DatHangs.Where(m => m.Id == id).FirstOrDefault();
            ...
            foreach (var item in order_details)
            {
                ...
                var product = _context.SanPhams.Where(m => m.Id == item.SanPhamId).FirstOrDefault();
            ...
            _context.DatHangs.Update(o);
            _context.SaveChanges();
            return RedirectToAction("MyCheckOut");
        }
